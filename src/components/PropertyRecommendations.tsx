...
import { TrendingUp, Target, AlertTriangle, CheckCircle, DollarSign, Building, Star, RefreshCw } from 'lucide-react'
...
const PropertyRecommendations: React.FC<PropertyRecommendationsProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 backdrop-blur-md border border-white/30 rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        {/* Header */}
    ...
    <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex gap-2 pt-3 border-t border-gray-100">
        <button
          ...
          className="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 px-3 rounded text-sm flex items-center justify-center transition-colors"
        >
          View on Map
        </button>
        <button
          onClick={() => onPropertySelect?.(property)}
          className="flex-1 bg-green-50 hover:bg-green-100 text-green-700 py-2 px-3 rounded text-sm flex items-center justify-center transition-colors"
        >
          Details
        </button>
      </div>
